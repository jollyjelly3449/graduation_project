...
components, eigenvalues = PCA(second[:5000].reshape(-1, 7), n_components=7)
...
second_elements = second.reshape(-1, 7) @ components.T

# plot(np.arange(100,5000), state[100:5000, 0, 1], second[100:5000, 0, 0], ylim=(-0.6, 0.6))
# plot(np.arange(100,5000), state[100:5000, 0, 1], second[100:5000, 0, 1], ylim=(-0.6, 0.6))
# plot(np.arange(100,5000), state[100:5000, 0, 1], second[100:5000, 0, 2], ylim=(-0.6, 0.6))
# plot(np.arange(100,5000), state[100:5000, 0, 1], second[100:5000, 0, 3], ylim=(-0.6, 0.6))
# plot(np.arange(100,5000), state[100:5000, 0, 1], second[100:5000, 0, 4], ylim=(-0.6, 0.6))
# plot(np.arange(100,5000), state[100:5000, 0, 1], second[100:5000, 0, 5], ylim=(-0.6, 0.6))
# plot(np.arange(100,5000), state[100:5000, 0, 1], second[100:5000, 0, 6], ylim=(-0.6, 0.6))
