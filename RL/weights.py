...
f1_0 = state_dict["rnn.rnn_cell.layer_0.ff1.weight"] * (1 - sparse_0)
sparse_1 = state_dict["rnn.rnn_cell.layer_1.sparsity_mask"]
f1_1 = state_dict["rnn.rnn_cell.layer_1.ff1.weight"] * (1 - sparse_1)
sparse_2 = state_dict["rnn.rnn_cell.layer_2.sparsity_mask"]
f1_2 = state_dict["rnn.rnn_cell.layer_2.ff1.weight"] * (1 - sparse_2)
